...
---STORE PROCEDURE PARA VER CLIENTES

CREATE PROCEDURE  VER_CLIENTE
AS
SELECT   NOMBRES,APELLIDOS,DNI,EDAD,DIRECCION,PROVINCIA,GENERO,FECHA,FOTO
FROM CLIENTE
GO
--STORE PROCEDURA PARA BUSCAR CLINENTE
...
ALTER TABLE CONDUCTOR DROP COLUMN FOTO;
...
AS
BEGIN
	insert into CONDUCTOR(PLACA,AÑO,COLOR,NOMBRES,APELLIDOS,DNI,EDAD,DIRECCION,PROVINCIA,FECHA)	values 
	(@PLACA,@AÑO,@COLOR,@NOMBRES,@APELLIDOS,@DNI,@EDAD,@DIRECCION,@PROVINCIA,@FECHA)
END
GO
...
BEGIN
    ...
    DIRECCION=@DIRECCION,PROVINCIA=@PROVINCIA WHERE @NOMBRES = @NOMBRES;
